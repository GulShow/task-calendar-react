...
class ReminderForm extends Component {
  ...
  getInitialValues = () => {
    const { description, color, date, time, action } = this.props.reminder;
    ...
    return (
      ...
      >
        <Form className="w-full flex flex-col gap-3">
          ...
          <FormFieldset>
            <FormLabel htmlFor="action">Description</FormLabel>
            <Field
              id="action"
              name="action"
              component={FormTextInput}
            ...
            />
            <ErrorMessage component={FormErrorMessage} name="action" />
          </FormFieldset>

          <ReminderForecastContainer names={{ action: 'action', date: 'date' }} />
